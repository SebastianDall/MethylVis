<script lang="ts">
  ...
  // let projects = $state([]);
  // let currentView = $state("create");

</script>


<main class="min-h-screen bg-gray-300 flex items-center justify-center p-4">
	<div class="flex w-full h-screen gap-4">
		...
		<div class="card w-full bg-white rounded-lg mb-6">
			hello
